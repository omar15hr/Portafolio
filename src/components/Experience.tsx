const experience = [
  {
    ...
    workDone: [
      "Diseñe landing page del sitio web de la OTEC de La Florida. Enfocado a las noticias y cursos que ofrecen. Utilicé CSS y HTML.",
      "Desarrollé bloque de Moodle, que permite a los administradores del sitio obtener información sobre el status de los alumnos y sus cursos. Utilicé PHP, MySQL, HTML y CSS.",
